...
library(RNetCDF)
fl <- open.nc('D:/DryDepPrim/ERA20162017_List.nc') #Listvyanka
print.nc(fl)
data <- read.nc(fl)
close.nc(fl)

fl <- open.nc('D:/DryDepPrim/RH_List.nc') #Listvyanka
print.nc(fl)
...
V_LIST_NH3_2016 <- array(0,dim=c(length(lon),length(lat),length(duration)))
V_LIST_O3_2016 <- array(0,dim=c(length(lon),length(lat),length(duration)))
V_LIST_SO2_2016 <- array(0,dim=c(length(lon),length(lat),length(duration)))
...
beta_ns <- 1/22
SO2 <- rep(NULL,times=1464)

SO2[1:(w<-(5*4))] <- 452.4
SO2[(w+1):(w<-(w+10*4))] <- 351.61
SO2[(w+1):(w<-(w+5*4))] <- 1172.49
SO2[(w+1):(w<-(w+7*4))] <- 382.08
SO2[(w+1):(w<-(w+7*4))] <- 198.57
SO2[(w+1):(w<-(w+7*4))] <- 310.72
SO2[(w+1):(w<-(w+7*4))] <- 198.34
SO2[(w+1):(w<-(w+7*4))] <- 307.45
SO2[(w+1):(w<-(w+7*4))] <- 772.19
SO2[(w+1):(w<-(w+7*4))] <- 207.04
SO2[(w+1):(w<-(w+7*4))] <- 128.5
SO2[(w+1):(w<-(w+7*4))] <- 359.63
SO2[(w+1):(w<-(w+7*4))] <- 260.7
SO2[(w+1):(w<-(w+6*4))] <- 569.14
SO2[(w+1):(w<-(w+8*4))] <- 101
SO2[(w+1):(w<-(w+7*4))] <- 130.8
SO2[(w+1):(w<-(w+6*4))] <- 71.37
SO2[(w+1):(w<-(w+8*4))] <- 58.2
SO2[(w+1):(w<-(w+7*4))] <- 27.64
SO2[(w+1):(w<-(w+7*4))] <- 58.94
SO2[(w+1):(w<-(w+7*4))] <- 30.17
SO2[(w+1):(w<-(w+6*4))] <- 44.75
SO2[(w+1):(w<-(w+7*4))] <- 19.52
SO2[(w+1):(w<-(w+8*4))] <- 50.42
SO2[(w+1):(w<-(w+7*4))] <- 49.3
SO2[(w+1):(w<-(w+14*4))] <- 23.91
SO2[(w+1):(w<-(w+7*4))] <- 23.95
SO2[(w+1):(w<-(w+7*4))] <- 31.24
SO2[(w+1):(w<-(w+7*4))] <- 46.59
SO2[(w+1):(w<-(w+7*4))] <- 13.69
SO2[(w+1):(w<-(w+7*4))] <- 3.91
SO2[(w+1):(w<-(w+7*4))] <- 8.23
SO2[(w+1):(w<-(w+6*4))] <- 2.62
SO2[(w+1):(w<-(w+7*4))] <- 4.8
SO2[(w+1):(w<-(w+7*4))] <- 1.92
SO2[(w+1):(w<-(w+7*4))] <- 14.29
SO2[(w+1):(w<-(w+8*4))] <- 1.6
SO2[(w+1):(w<-(w+7*4))] <- 14.22
SO2[(w+1):(w<-(w+7*4))] <- 2.73
SO2[(w+1):(w<-(w+7*4))] <- 8.62
SO2[(w+1):(w<-(w+7*4))] <- 2.96
SO2[(w+1):(w<-(w+7*4))] <- 159.32
SO2[(w+1):(w<-(w+7*4))] <- 66.85
SO2[(w+1):(w<-(w+7*4))] <- 170.66
SO2[(w+1):(w<-(w+7*4))] <- 159.1
SO2[(w+1):(w<-(w+7*4))] <- 587.13
SO2[(w+1):(w<-(w+7*4))] <- 208.97
SO2[(w+1):(w<-(w+7*4))] <- 197.86
SO2[(w+1):(w<-(w+7*4))] <- 130.16
SO2[(w+1):(w<-(w+7*4))] <- 450.14
SO2[(w+1):(w<-(w+7*4))] <- 300
SO2[(w+1):(w<-(w+3*4))] <- 199.51

#TEMPORARY!!!!!!!!!!!!!!!!!!!!!!! Insert MERRA SO2
#SO2 <- so2.Baikal[11,19,1:1464]*1e12/64.066


NH3 <- rep(NULL,times=1464)
NH3[1:(w<-(5*4))] <- 28.65 
NH3[(w+1):(w<-(w+10*4))] <- 33.79
NH3[(w+1):(w<-(w+5*4))] <- 37.47
NH3[(w+1):(w<-(w+7*4))] <- 89.96
NH3[(w+1):(w<-(w+7*4))] <- 7.38
NH3[(w+1):(w<-(w+7*4))] <- 57.87
NH3[(w+1):(w<-(w+7*4))] <- 27.98
NH3[(w+1):(w<-(w+7*4))] <- 18.88
NH3[(w+1):(w<-(w+7*4))] <- 112.58
NH3[(w+1):(w<-(w+7*4))] <- 81.41
NH3[(w+1):(w<-(w+7*4))] <- 110.74
NH3[(w+1):(w<-(w+7*4))] <- 56.45
NH3[(w+1):(w<-(w+7*4))] <- 91.36
NH3[(w+1):(w<-(w+6*4))] <- 88.55
NH3[(w+1):(w<-(w+8*4))] <- 30.75
NH3[(w+1):(w<-(w+7*4))] <- 98.54
NH3[(w+1):(w<-(w+6*4))] <- 53.88
NH3[(w+1):(w<-(w+8*4))] <- 167.89
NH3[(w+1):(w<-(w+7*4))] <- 90.74
NH3[(w+1):(w<-(w+7*4))] <- 394.54
NH3[(w+1):(w<-(w+7*4))] <- 139.86
NH3[(w+1):(w<-(w+6*4))] <- 182.62
NH3[(w+1):(w<-(w+7*4))] <- 200
NH3[(w+1):(w<-(w+8*4))] <- 240.82
NH3[(w+1):(w<-(w+7*4))] <- 265.46
NH3[(w+1):(w<-(w+14*4))] <-181.56
NH3[(w+1):(w<-(w+7*4))] <- 389.74
NH3[(w+1):(w<-(w+7*4))] <- 212.84
NH3[(w+1):(w<-(w+7*4))] <- 275.62
NH3[(w+1):(w<-(w+7*4))] <- 479.22
NH3[(w+1):(w<-(w+7*4))] <- 289.59
NH3[(w+1):(w<-(w+7*4))] <- 224.15
NH3[(w+1):(w<-(w+6*4))] <- 180.7
NH3[(w+1):(w<-(w+7*4))] <- 108.21
NH3[(w+1):(w<-(w+7*4))] <- 336.6
NH3[(w+1):(w<-(w+7*4))] <- 466.29
NH3[(w+1):(w<-(w+8*4))] <- 338.72
NH3[(w+1):(w<-(w+7*4))] <- 419.29
NH3[(w+1):(w<-(w+7*4))] <- 281.04
NH3[(w+1):(w<-(w+7*4))] <- 100#0 strange data so take 100
NH3[(w+1):(w<-(w+7*4))] <- 16.96
NH3[(w+1):(w<-(w+7*4))] <- 211.54
NH3[(w+1):(w<-(w+7*4))] <- 301.55
NH3[(w+1):(w<-(w+7*4))] <- 121.06
NH3[(w+1):(w<-(w+7*4))] <- 353.04
NH3[(w+1):(w<-(w+7*4))] <- 172.55
NH3[(w+1):(w<-(w+7*4))] <- 155.41
NH3[(w+1):(w<-(w+7*4))] <- 155.41#0.1 was strange data so took the previous
NH3[(w+1):(w<-(w+7*4))] <- 183.7
NH3[(w+1):(w<-(w+7*4))] <- 56.33
NH3[(w+1):(w<-(w+7*4))] <- 25.85
NH3[(w+1):(w<-(w+3*4))] <- 82.38
...
V_LIST_NH3_2016[lon_num,lat_num,] <- 1/(R_ah+R_b_NH3+R_c_NH3) # deposition velocity [m/s]
#V_LIST_O3_2016[lon_num,lat_num,] <- 1/(R_ah+R_b+R_c_O3)
V_LIST_SO2_2016[lon_num,lat_num,] <- 1/(R_ah+R_b_SO2+R_c_SO2)
