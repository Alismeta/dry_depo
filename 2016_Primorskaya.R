...
fl <- open.nc('D:/DryDepPrim/RH_Prim.nc') #Listvyanka
print.nc(fl)
da <- read.nc(fl) #Relat Humidity from reanalysis
close.nc(fl)

RH_grid <- da$r*0.00135097323501152+56.6095673570104
...
sol_rad_grid <- ((data$ssrd)*44.2219492469443+1448976.38902538)/3600 #solar radiation for stability class
...
RH <- RH_grid[1,1,duration]#RH_grid[lon_num,lat_num,duration]
...
SO2[1:(w<-(14*4))] <- 66
SO2[(w+1):(w<-(w+16*4))] <- 33.72
SO2[(w+1):(w<-(w+16*4))] <- 61.01
SO2[(w+1):(w<-(w+14*4))] <- 30.55
SO2[(w+1):(w<-(w+15*4))] <- 37.67
SO2[(w+1):(w<-(w+16*4))] <- 34.73
SO2[(w+1):(w<-(w+15*4))] <- 19.88
SO2[(w+1):(w<-(w+15*4))] <- 24.22
SO2[(w+1):(w<-(w+15*4))] <- 33.98
SO2[(w+1):(w<-(w+16*4))] <- 39.36
SO2[(w+1):(w<-(w+15*4))] <- 20.28
SO2[(w+1):(w<-(w+15*4))] <- 18.62
SO2[(w+1):(w<-(w+15*4))] <- 67.48
SO2[(w+1):(w<-(w+16*4))] <- 30.92
SO2[(w+1):(w<-(w+15*4))] <- 21.03
SO2[(w+1):(w<-(w+16*4))] <- 12.35
SO2[(w+1):(w<-(w+15*4))] <- 11.86
SO2[(w+1):(w<-(w+15*4))] <- 14.05
SO2[(w+1):(w<-(w+15*4))] <- 1.54
SO2[(w+1):(w<-(w+16*4))] <- 17.49
SO2[(w+1):(w<-(w+15*4))] <- 35.13
SO2[(w+1):(w<-(w+15*4))] <- 45.77
SO2[(w+1):(w<-(w+15*4))] <- 41.75
SO2[(w+1):(w<-(w+16*4))] <- 35.55

NH3 <- rep(NULL,times=1464)
NH3[1:(w<-(14*4))] <- 42.19
NH3[(w+1):(w<-(w+16*4))] <- 31.91
NH3[(w+1):(w<-(w+16*4))] <- 70.71
NH3[(w+1):(w<-(w+14*4))] <- 61.56
NH3[(w+1):(w<-(w+15*4))] <- 42.48
NH3[(w+1):(w<-(w+16*4))] <- 119.12
NH3[(w+1):(w<-(w+15*4))] <- 94.74
NH3[(w+1):(w<-(w+15*4))] <- 177.97
NH3[(w+1):(w<-(w+15*4))] <- 133.49
NH3[(w+1):(w<-(w+16*4))] <- 122.17
NH3[(w+1):(w<-(w+15*4))] <- 51.26
NH3[(w+1):(w<-(w+15*4))] <- 69.08
NH3[(w+1):(w<-(w+15*4))] <- 98.20
NH3[(w+1):(w<-(w+16*4))] <- 253.42
NH3[(w+1):(w<-(w+15*4))] <- 199.62
NH3[(w+1):(w<-(w+16*4))] <- 233.95
NH3[(w+1):(w<-(w+15*4))] <- 144.99
NH3[(w+1):(w<-(w+15*4))] <- 53.39
NH3[(w+1):(w<-(w+15*4))] <- 16.26
NH3[(w+1):(w<-(w+16*4))] <- 74.51
NH3[(w+1):(w<-(w+15*4))] <- 26.33
NH3[(w+1):(w<-(w+15*4))] <- 108.38
NH3[(w+1):(w<-(w+15*4))] <- 26.29
NH3[(w+1):(w<-(w+16*4))] <- 189.9
