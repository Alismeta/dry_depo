...
SO2[1:(w<-(14*4))] <- 16.3
SO2[(w+1):(w<-(w+16*4))] <- 11.27
SO2[(w+1):(w<-(w+15*4))] <- 30.64
SO2[(w+1):(w<-(w+13*4))] <- 60.47
SO2[(w+1):(w<-(w+15*4))] <- 32.55
SO2[(w+1):(w<-(w+16*4))] <- 4.89
SO2[(w+1):(w<-(w+15*4))] <- 6.81
SO2[(w+1):(w<-(w+15*4))] <- 25.18
SO2[(w+1):(w<-(w+15*4))] <- 15.25
SO2[(w+1):(w<-(w+16*4))] <- 7.64
SO2[(w+1):(w<-(w+15*4))] <- 12.85
SO2[(w+1):(w<-(w+15*4))] <- 7.67
SO2[(w+1):(w<-(w+15*4))] <- 17.85
SO2[(w+1):(w<-(w+16*4))] <- 0.87
SO2[(w+1):(w<-(w+15*4))] <- 0.1
SO2[(w+1):(w<-(w+16*4))] <- 15.32
SO2[(w+1):(w<-(w+15*4))] <- 2.02
SO2[(w+1):(w<-(w+15*4))] <- 5.2
SO2[(w+1):(w<-(w+15*4))] <- 10.0
SO2[(w+1):(w<-(w+16*4))] <- 23.99
SO2[(w+1):(w<-(w+15*4))] <- 10.74
SO2[(w+1):(w<-(w+15*4))] <- 19.22
SO2[(w+1):(w<-(w+15*4))] <- 14.25
SO2[(w+1):(w<-(w+17*4))] <- 18.22


NH3 <- rep(NULL,times=1460)

NH3[1:(w<-(14*4))] <- 51.25 
NH3[(w+1):(w<-(w+16*4))] <- 13.64 
NH3[(w+1):(w<-(w+15*4))] <- 9.5
NH3[(w+1):(w<-(w+13*4))] <- 29.12
NH3[(w+1):(w<-(w+15*4))] <- 23.34
NH3[(w+1):(w<-(w+16*4))] <- 26.58
NH3[(w+1):(w<-(w+15*4))] <- 15.57
NH3[(w+1):(w<-(w+15*4))] <- 43.27
NH3[(w+1):(w<-(w+15*4))] <- 45.81
NH3[(w+1):(w<-(w+16*4))] <- 38.64
NH3[(w+1):(w<-(w+15*4))] <- 31.02
NH3[(w+1):(w<-(w+15*4))] <- 54.28
NH3[(w+1):(w<-(w+15*4))] <- 52.57
NH3[(w+1):(w<-(w+16*4))] <- 101.91
NH3[(w+1):(w<-(w+15*4))] <- 50.44
NH3[(w+1):(w<-(w+16*4))] <- 60.20
NH3[(w+1):(w<-(w+15*4))] <- 25.44
NH3[(w+1):(w<-(w+15*4))] <- 36.11
NH3[(w+1):(w<-(w+15*4))] <- 24.1
NH3[(w+1):(w<-(w+16*4))] <- 38.67
NH3[(w+1):(w<-(w+15*4))] <- 12.04
NH3[(w+1):(w<-(w+15*4))] <- 23.67
NH3[(w+1):(w<-(w+15*4))] <- 8.17
NH3[(w+1):(w<-(w+17*4))] <- 14.29
